$packageName = 'MMDB.WebsiteBeaterUpper'
$installerType = 'EXE' #only one of these two: exe or msi
$url = 'https://github.com/mmooney/MMDB.Testing' # download url
...
#Install-ChocolateyPackage "MMDB.WebsiteBeaterUpper" "EXE" "" "$url" "$url64"  -validExitCodes $validExitCodes
